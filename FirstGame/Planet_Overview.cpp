...
void Planet_Overview::Planet_Window_Main() {
	...
	if (show_planet_overview_window) {
		...
		Begin("Planet Overview23", &show_planet_overview_window);   // Pass a pointer to our bool variable (the window will have a closing button that will clear the bool when clicked)
